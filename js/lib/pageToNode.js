...
(function () {
  ...
  window.webkitConvertPointFromPageToNode = function (element, coords) {
    return getTransformationMatrix(element).inverse().transformPoint(new Point(coords.x, coords.y, 0));
  };
